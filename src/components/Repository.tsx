...
export const Repository = ({node, comments}:RepositoryPropType) => {
  ...
  return (
    <div className='mt-5 border-2 shadow-md  container mx-auto min-w-full  h-[12rem]'>
      <div className='flex flex-col'>
        ...
        {<div className='h-16 px-2 pt-2 mx-auto text-lg overflow-auto text-gray-800 md:text-xl'>{node.description ? node.description : "This repository doens't have a description"}</div>}
